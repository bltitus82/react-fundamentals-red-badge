    ...
    return (
        <div className="main">
            <div className="mainDiv">
                ...
                <p>Below are some of the resources that we used throughout this app. NOTE: You'll have
                    one challenge where you will be asked to make this page better.
                </p>
                <ul>
                    <li>
                    ...
                    <li>
                        <a href="https://www.udemy.com/course/reacht-the-guide-incl-redux" target="_blank">
